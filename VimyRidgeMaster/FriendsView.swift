...
class FriendsView: UITableViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        println("You are in the Friends view")
        ...
        if (battalion_name != "")
        {
            ...
            var url : String = "http://lest-we-forget.ca/apis/search2.php?access_code=SFDCI_Black&action=search_battalion&battalion=\(battalion_name)"
